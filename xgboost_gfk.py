...
save_dir = desktop_dir / "eeg_xgb_groupkfold"
save_dir.mkdir(parents=True, exist_ok=True)

MODEL_DIR = save_dir / "xgb_models"
MODEL_DIR.mkdir(parents=True, exist_ok=True)

scaler_path = save_dir / "scaler_xgb_groupkfold.joblib"
feature_names_path = save_dir / "feature_names_groupkfold.csv"
results_path = save_dir / "xgb_results_groupkfold.txt"
feature_importances_path = save_dir / "xgb_feature_importances_groupkfold.csv"
...
if __name__ == "__main__":
    ...
    with open(results_path, "w", encoding="utf-8") as f:
        for i, (train_idx, test_idx) in enumerate(tqdm(skf.split(X, y, groups), desc="K-Fold CV (GroupKFold)")):
            ...
            joblib.dump(clf, MODEL_DIR / f"xgb_model_groupkfold_fold{i+1}.joblib")
